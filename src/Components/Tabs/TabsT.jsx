    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Worries')}>
                <Ionicons name="document-text-outline" size={32} color="#1f971f" style={{ marginTop: 10, marginLeft: 30 }} />
                <Text style={{ fontSize: 11, marginLeft: 25, color: "#1f971f" }}>WORRIES</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity>
                <AntDesign name="infocirlceo" size={32} color="tomato" style={{ marginTop: 10, marginLeft: 130, flexDirection: "column" }} />
                <Text style={{ fontSize: 11, marginLeft: 135, color: "tomato" }}>Tips</Text>
            </TouchableOpacity>
