...
function Tabs() {
    ...
    return (
        <View style={{
            height: 60, backgroundColor: "white", width: 400, elevation: 5, flexDirection: "row",
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Setup')}>
                ...
                <Feather name="settings" size={32} color="tomato" style={{ marginTop: 10, marginLeft: 40, flexDirection: "column" }} />
                <Text style={{ fontSize: 11, marginLeft: 45, color: "tomato" }}>SETUP</Text>
            </TouchableOpacity>
